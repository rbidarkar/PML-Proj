...
testNew <- testing[,colSums(is.na(testing)) == 0]
```
...
As you can see from the accuracy of the model, needless to say for this data, random forest method works better than the other model. The accuracy rate is 0.9992, the out-of-sample error rate is 0.0008. 
